...
const stepEndValue = flowDataObj.nodes.length;
        ...
        const bodyData = flowDataObj // Assuming you want to send the entire flowData object
    ...
    res.json({ message: 'Webhook executed successfully', webhookData: webhookResponse.data });
  })
