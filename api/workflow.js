...
router.post('/webhook/:shortId', async (req, res) => {
 ...
 const tenantId = req.query['X-Tenant-ID'];    
...
// Calculate the length of the flowData.nodes array
 let nodesArray = [];
    ...
    const stepEndValue = nodesArray.length - 1;
        ...
        const webhookUrl = `https://aws-steps-typescript-ten.vercel.app/api/step-v3/0?stepEnd=${stepEndValue}`;
